...
{/* TODO: screenshot — Status Control page */}

## Tournament Statuses

Tournaments progress through these states:

**Draft** → **Published** → **Registration Open** → **Registration Closed** → **Live** → **Completed**
...
Each transition card shows a risk level:
...
> **Tip:** The Status Control page shows every available transition with a description of what will happen and what it affects. Read the impact list before confirming — especially for high-risk actions.

## Match Statuses

Matches have their own lifecycle:

**Not Scheduled** → **Scheduled** → **Live** → **Completed**

A match can also be **Cancelled** at any point.

From the group or pairing page, use the match action buttons to progress: **Set Schedule** → **Start Match** → **End Match** (or **Cancel**).

Scheduled and Live matches block stage completion — they must be either completed or cancelled before you can complete the stage.

## Accessing Status Control

For tournaments: from the Tournament Dashboard, click the **Status** button. For matches: from the group page, select a match and use the action buttons.
