...
- **Require Game UID & IGN** — players must provide their Free Fire User ID and In-Game Name. Can be enabled independently from full roster.
...
| Paid scrims or high-stakes invitational | Invite with Approval |
